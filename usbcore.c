...
extern uint32_t USB_ReqGetDescriptor (void);
extern uint32_t USB_ReqGetStatus (void);
extern uint32_t USB_ReqSetClrFeature (uint32_t sc);
extern uint32_t USB_ReqSetConfiguration (void);
extern uint32_t USB_ReqSetInterface (void);
